...
#+SETUPFILE: https://yqrashawn.com/org-html-themes/org/theme-readtheorg.setup
...
I've written a [[file:org/org-mode-syntax-example.txt][demo page]] for the themes that provides a maximal working support
of Org mode syntax.
...
1. You *add a* =#+SETUPFILE:= *directive* in the preamble of your document (to include
   ...
   ,#+SETUPFILE: https://yqrashawn.com/org-html-themes/org/theme-NAME.setup
   #+end_src
